...
const Cart = () => {
    ...
    const onCleatCart = () => {
        // if (window.confirm('Вы уверечны, что хотите удалить все пиццы с корзины')) {
        dispatch(clearCart())
        // }
    }
        ...
        <div className='container container--cart'>
         ...
         Корзина</h2>
                    <div className="cart__clear">
                        ...
                        <p onClick={onCleatCart}>Очистить корзину</p>
                    </div>
                </div>
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <div> Всего пицц: <b>{totalCount} шт.</b> </div>
                        <div> Сумма заказа: <b>{totalPrice} грн</b> </div>
                    </div>
                    <div className="cart__bottom-buttons">
                        <Link to="/" className="button button--outline button--add go-back-btn">
                            <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 13L1 6.93015L6.86175 1" stroke="#262626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
